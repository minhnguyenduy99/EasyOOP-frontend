  ...
  <div id="create-post-form">
    <ValidationObserver tag="form" ref="validator" class="ha-vertical-layout-5">
      ...
      <div id="form-second-row">
        ...
        <validated-form-element name="thumbnail" label="Chọn ảnh đại diện">
          <b-upload
          ...
          >
            <section class="section">
              <div
                v-if="!form.thumbnail_file && !thumbnailDataURL"
...
import EditPostFormMixin from "./mixins/edit-post-form.mixin";
import PostFormMixin from "./mixins/post-form.mixin";

export default {
  name: "EditPostForm",
  mixins: [PostFormMixin, EditPostFormMixin],
  components: {
    ValidationObserver,
